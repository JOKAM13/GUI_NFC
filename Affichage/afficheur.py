...
class Afficheur(QtWidgets.QMainWindow):
    def __init__(self, controle: ControleDonnee):
        ...
        # Zone centrale: grille + panneau droit pour les tableaux de contrôle
        center = QtWidgets.QHBoxLayout(); center.setSpacing(12); root.addLayout(center)

        # Grille 3x5 TODO: ON DOIT MODIFIER CETTE PARTIE  pour que le nombre de case soit générique
        ...
        # Panneau droit pour les contrôles de commande
        ...
        # Image décorative (J'ai pas encore ajouté une image de souris dans assets/mouse.png)
        ...
        # Précharger la liste des souris déjà connues 
        try:
